...
export default function CheckoutPage() {
  ...
  // FIXED: Redirect moved to useEffect
  useEffect(() => {
    if (items.length === 0) {
      router.push('/cart');
    }
      ...
      <div className="max-w-6xl mx-auto px-4 py-10">
        ...
        <div className="flex items-center gap-4 mb-10">
          {['Delivery', 'Payment', 'Review'].map((s, i) => (
            <div key={s} className="flex items-center gap-2">
              <div
                className={`w-8 h-8 rounded-full flex items-center justify-center font-poppins text-sm font-semibold ${
                  step > i + 1
        ...
        <div className="grid lg:grid-cols-3 gap-10">
          <div className="lg:col-span-2">
            ...
            {step === 1 && (
              <div className="glass-card rounded-2xl p-6 border border-gold/20">
                <h2 className="font-playfair font-bold text-text-dark text-lg mb-6">
                  Delivery Details
                </h2>
                ...
                <div className="grid sm:grid-cols-2 gap-4">
                  {[
                    ...
                    >
                      <label className="font-poppins text-xs font-semibold text-text-dark mb-1 block">
                        {label}
                      </label>
                ...
                <button
                  onClick={() => setStep(2)}
                  className="btn-primary mt-6 px-8 py-3 text-sm font-semibold"
                >
                  Continue to Payment →
                </button>
              </div>
                    ...
                    <label
                      ...
                      className={`flex items-center gap-4 p-4 rounded-xl border-2 cursor-pointer transition-all ${
                        form.paymentMethod === p.value
                          ...
                          : 'border-gold/20 hover:border-primary/50'
                      }`}
                    >
                      <input
                        type="radio"
            ...
            {step === 3 && (
              <div className="glass-card rounded-2xl p-6 border border-gold/20">
                ...
                <div className="space-y-3 mb-6">
                  {items.map((item) => (
                    <div
                      ...
                      className="flex items-center gap-3 pb-3 border-b border-gold/10 last:border-0"
                    >
                      <img
                        src={
                          item.image ||
                      ...
                      <div className="flex-1">
                        <p className="font-poppins text-sm text-text-dark font-medium line-clamp-1">
                          {item.name}
                        </p>
                ...
                <div className="bg-accent/10 rounded-xl p-4 mb-6">
                  ...
                  <p className="font-poppins text-sm text-text-dark font-medium">
                    {form.name}
                  </p>
          ...
          <div className="glass-card rounded-2xl p-6 border border-gold/20 h-fit sticky top-24">
            <h3 className="font-playfair font-bold text-text-dark text-lg mb-4 pb-3 border-b border-gold/20">
              Summary
            </h3>
